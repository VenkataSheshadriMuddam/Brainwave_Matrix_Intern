    ...
    public static Connection getconnection() {
        try {
            ...
            return DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/ATMINTERFACE", "root", "Badri@4829"
            );
        } catch (Exception e) {
...
public class ATMInterface {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            System.out.println("\n*** WELCOME TO VENKATASHESHADRI ATM INTERFACE ***");
            ...
            switch (choice) {
                ...
                case 3 -> {
                    System.out.println("Thank you for using VENKATASHESHADRI ATM!");
                    running = false;
                }
            }
        }
